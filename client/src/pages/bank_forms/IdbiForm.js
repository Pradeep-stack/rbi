      ...
      <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div className="d-block mb-4 mb-md-0">
          <Breadcrumb className="d-none d-md-inline-block" listProps={{ className: "breadcrumb-dark breadcrumb-transparent" }}>
            ...
            <Breadcrumb.Item> Industrial Development Bank of India </Breadcrumb.Item>
            ...
            <Card.Body><div className="text-right">
              ...
              <Form method="POST" >
                ...
                <Row>
                  <Col md={6} className="mb-3">
                    <Form.Group id="firstName">
                      <Form.Label>1. Descriptive account on whether the building is modern,
                        ...
                        elements heritage value if applicable, presence of
                  ...
                  <Col md={6} className="mb-3">
                    <Form.Group id="firstName">
                      <Form.Control required as="textarea" rows={3} name="date" value={task.ingssfouncef}
                        placeholder=" write here" />
                    </Form.Group>
                  </Col>
                </Row>
                ...
                <Row>
                  ...
                  <Col md={6} className="mb-3">
                    <Form.Group id="firstName">
                      <Form.Control required as="textarea" rows={8} name="date" value={task.ingssfouncef}
                        placeholder=" write" />
                    </Form.Group>
                  </Col>
                </Row>
                <Row><p>As a result of my appraisal and analysis, it is my considered opinion that the present fair market value of
                  ...
                  <p>i) Date of purchase of immovable property: To be given by owner<br></br>
                    ...
                    iii) Book value (Realizable value) of immovable property: Rs.<Form.Control type="text" size="10" /> _ _ _ _ _ _ _ _ _  _,<br></br>
...
<<<<<<< HEAD
                  <Col md={6} className="mt-5 text-left">
                    <Button variant="primary" onClick={postData} type="submit">Preview</Button>
                  </Col>
=======
